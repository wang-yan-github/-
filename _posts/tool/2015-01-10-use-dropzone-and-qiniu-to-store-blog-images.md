...
![七牛操作流](https://wang-yan-blog.oss-cn-beijing.aliyuncs.com/tool-qiniu-workflow.gif)
...
1. 去七牛注册帐号
    ...
    ![标准帐号](https://wang-yan-blog.oss-cn-beijing.aliyuncs.com/tool-qiniu-normal-account.png)

2. 创建一个空间

    创建空间也比较容易，记得选择公开空间。

    ![创建空间](https://wang-yan-blog.oss-cn-beijing.aliyuncs.com/tool-qiniu-create-bucket.png)
...
4. 启用插件
    ...
    ![启用插件](https://wang-yan-blog.oss-cn-beijing.aliyuncs.com/tool-use-bundle.png)
    ...
    ![access key](https://wang-yan-blog.oss-cn-beijing.aliyuncs.com/tool-qiniu-access-key.png)

    ![root url](https://wang-yan-blog.oss-cn-beijing.aliyuncs.com/tool-qiniu-root-url.png)
